...
@section('container')
    <div class="card">
        <div class="card-body">
            <form class="form-horizontal" method="post" action="/admin/toko" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="card-body d-flex justify-content-center mt-2">
                    <a href="{{ route('toko.indexs') }}" class="btn btn-info me-1"><i data-feather="arrow-left"></i></a>
