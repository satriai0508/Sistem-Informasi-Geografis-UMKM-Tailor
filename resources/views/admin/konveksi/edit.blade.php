...
<div class="card">
  <div class="card-body">
    <form action="/admin/konveksi/{{ strtolower($konveksis->nama) }}" method="post">
      @method('put')
      @csrf
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-md-6">
          <input type="number" min="5000" max="100000" step="5000" class="form-control form-control-plaintext @error('harga')
                                is-invalid
                            @enderror" id="harga" name="harga" placeholder="Ex. 5000 (Rp)" required value="{{ old('harga', $konveksis->harga) }}" />
          @error('harga')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-md-6">
          <input type="text" class="form-control form-control-plaintext @error('ukuran')
                                is-invalid
                            @enderror" id="ukuran" name="ukuran" placeholder="Ex: S, M, L, XL, XXL." required value="{{ old('ukuran',$konveksis->ukuran) }}" />
          @error('ukuran')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-md-6">
          <input type="text" class="form-control form-control-plaintext @error('jenis')
                                is-invalid
                            @enderror" id="jenis" name="jenis" placeholder="Ex : Cut, Make, Trim." required value="{{ old('jenis',$konveksis->jenis) }}" />
          @error('jenis')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
