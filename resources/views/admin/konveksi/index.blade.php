...
<div class="container container-fluid">
  <div class="card">
    <div class="card-body">
      <a href="/admin/konveksi/create" class="btn btn-success mb-2"><i data-feather="file-plus"></i></a>
        ...
        <table class="table table-striped table-bordered" id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              @if($konveksi->nama_toko)
              <td>{!! $konveksi->nama_toko !!}</td>
              @else
              <td>
